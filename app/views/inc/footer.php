<footer>
    ...
    <div class="container py-4 py-lg-5">
        ...
        <div class="text-muted d-flex justify-content-between align-items-center pt-3">
            <p class="mb-0">Copyright © <span id="year"></span> Galaxy Distribution | <a href="https://galaxylifeline.com/Ambt/privacy" target="_blank" rel="noopener noreferrer nofollow">
  Privacy Policy
